...
% esn.methodTrain(for ex linear regression using pseudo-inverse)
...
switch trained_esn.learningMode
    case 'offline_singleTimeSeries'
        ...
        trained_esn.outputWeights{trained_esn.IDsubNet} = feval(trained_esn.methodWeightCompute, stateCollection, teacherCollection) ;
    ...
    case  'offline_multipleTimeSeries'   
        ...
        trained_esn.outputWeights{trained_esn.IDsubNet} = ...
    ...
    case 'online'
        ...
        for iInput = 1 : nSampleInput
            ...
            error(iInput , 1 ) = e*e ; 
            % update the weights 
            trained_esn.outputWeights{trained_esn.IDsubNet}(1,:) = trained_esn.outputWeights{trained_esn.IDsubNet}(1,:) + (k*e)' ;             
...
trained_esn.trained(trained_esn.IDsubNet) = 1 ;          
